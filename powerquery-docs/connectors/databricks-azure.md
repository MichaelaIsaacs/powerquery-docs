...
3. Provide your credentials to authenticate with your Databricks SQL Warehouse. There are three options for credentials:
    ...
    * Personal Access Token (usable for AWS, Azure, or GCP). For instructions on generating a Personal Access Token (PAT), see [Personal access tokens](/azure/databricks/sql/user/security/personal-access-tokens).
